...
mkdir releases/dcp-$VERSION-linux-armv7
...
mv releases/dcp-linux-armv7 releases/dcp-$VERSION-linux-armv7/dcp
...
cp LICENSE.md releases/dcp-$VERSION-linux-arm/
...
cp README.md releases/dcp-$VERSION-linux-arm/README
...
../node_modules/.bin/cross-zip dcp-$VERSION-linux-arm ../dist/dcp-$VERSION-linux-arm.zip
