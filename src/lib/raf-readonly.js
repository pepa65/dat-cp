// From https://github.com/random-access-storage/random-access-file/blob/master/index.js
// Changes: removed irrelevant things and readonly access
...
RandomAccessFile.prototype._write = function (req) {
	// Do nothing and avoid random-access-storage errors
	req.callback(null)
}
